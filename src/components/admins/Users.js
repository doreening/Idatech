...
<div class="flex flex-col  md:flex-row">
    ...
    <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
        ...
        <div class="bg-gray-800 p-2 shadow text-xl text-white">
            <h5 class="text-gray-700 text-xs font-bold pl-2">Manage and Add Users</h5>
        </div>
        ...
        <div class="w-full  shadow text-xl   ">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="header-title text-gray-700 text-lg font-bold">Users joined house church</h5>
